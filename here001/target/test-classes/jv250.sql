...
ALTER TABLE Customer CHANGE refDate regDate TIMESTAMP NOT NULL;
...
('222-22-2222', 5000.0, 0.0, 5000.0, "C" 1004),
('222-22-2222', 2000.0, 2.2, 3000.0, "S", 1004);

--inner join
SELECT * FROM Account, Customer 
WHERE Account.coustomerId = Customer.cid AND Customer.ssn = '901213-1234567';
